(function () {
    ...
    angular.module('Alfatih')
            .controller('LookupAkunEndpointController', LookupAkunEndpointController);
    function LookupAkunEndpointController($timeout, $stateParams, $uibModalInstance, $scope, $uibModal, $log, toastr, ParseLinks, AlertService, paginationConstants, lookupPagingParams, $state, AkunService) {

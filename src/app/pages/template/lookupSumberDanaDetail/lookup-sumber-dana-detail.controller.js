(function () {
    ...
    angular.module('Alfatih')
            .controller('LookupSumberDanaDetailController', LookupSumberDanaDetailController);
    function LookupSumberDanaDetailController($timeout, $stateParams, $uibModalInstance, $scope, $uibModal, $log, toastr, ParseLinks, AlertService, paginationConstants, lookupPagingParams, $state, SumberDanaDetailService) {
        ...
        ctrl.select = select;
        $scope.modalTitle = "Cari Sumber Dana Detail";
        loadAll();
        function loadAll() {
            SumberDanaDetailService.query({

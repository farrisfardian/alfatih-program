(function () {
    ...
    angular.module('Alfatih')
            .controller('LookupProgramEndpointController', LookupProgramEndpointController);
    function LookupProgramEndpointController($timeout, $stateParams, $uibModalInstance, $scope, $uibModal, $log, toastr, ParseLinks, AlertService, paginationConstants, lookupPagingParams, $state, ProgramService) {

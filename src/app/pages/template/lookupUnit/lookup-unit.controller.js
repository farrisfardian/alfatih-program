(function () {
    ...
    angular.module('Alfatih')
            .controller('LookupUnitController', LookupUnitController);
    function LookupUnitController($timeout, $stateParams, $uibModalInstance, $scope, $uibModal, $log, toastr, ParseLinks, AlertService, paginationConstants, lookupPagingParams, $state, UnitService) {

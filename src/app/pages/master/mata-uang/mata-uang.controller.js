(function () {
    ...
    /** @ngInject */
    function MataUangController($scope, $uibModal, $log, toastr, MataUangService, 
        ...
        function baru() {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'app/pages/master/mata-uang/mata-uang-dialog.html',
                controller: 'MataUangDialogController',
                controllerAs: 'vm',
                size: 'md',
                resolve: {
                    entity: function () {
        ...
        function ubah(x) {
            ...
            var modalInstance = $uibModal.open({
                ...
                size: 'md',
                resolve: {
                    entity: ['MataUangService', function (MataUangService) {
                            return MataUangService.get({id: x.id}).$promise;
                        }],
                }
            });
            modalInstance.result.then(function (selectedItem) {
        ...
        function hapus(x) {
            MataUangService.delete({id: x.id},function () {
